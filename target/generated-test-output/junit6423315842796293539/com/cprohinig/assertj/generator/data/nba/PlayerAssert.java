...
public class PlayerAssert extends AbstractObjectAssert<PlayerAssert, Player> {
   ...
   */
  public PlayerAssert hasName(com.cprohinig.assertj.generator.data.Name name) {
    // check that actual Player we want to make assertions on is not null.
    isNotNull();
    ...
    // null safe check
    com.cprohinig.assertj.generator.data.Name actualName = actual.getName();
   ...
   */
  public PlayerAssert hasPreviousTeamNames(String... previousTeamNames) {
    // check that actual Player we want to make assertions on is not null.
    isNotNull();
   ...
   */
  public PlayerAssert hasOnlyPreviousTeamNames(String... previousTeamNames) {
    // check that actual Player we want to make assertions on is not null.
    isNotNull();
   ...
   */
  public PlayerAssert doesNotHavePreviousTeamNames(String... previousTeamNames) {
    // check that actual Player we want to make assertions on is not null.
    isNotNull();
   ...
   */
  public PlayerAssert hasNoPreviousTeamNames() {
    // check that actual Player we want to make assertions on is not null.
    isNotNull();
   ...
   */
  public PlayerAssert hasSizeCloseTo(float size, float assertjOffset) {
    // check that actual Player we want to make assertions on is not null.
    isNotNull();
  ...
  /**
   * Verifies that the actual Player's previousTeams contains the given com.cprohinig.assertj.generator.data.nba.team.Team elements.
   * @param previousTeams the given elements that should be contained in actual Player's previousTeams.
   * @return this assertion object.
   * @throws AssertionError if the actual Player's previousTeams does not contain all given com.cprohinig.assertj.generator.data.nba.team.Team elements.
   */
  public PlayerAssert hasPreviousTeams(com.cprohinig.assertj.generator.data.nba.team.Team... previousTeams) {
    // check that actual Player we want to make assertions on is not null.
    isNotNull();

    // check that given com.cprohinig.assertj.generator.data.nba.team.Team varargs is not null.
  ...
  /**
   * Verifies that the actual Player's previousTeams contains the given com.cprohinig.assertj.generator.data.nba.team.Team elements in Collection.
   * @param previousTeams the given elements that should be contained in actual Player's previousTeams.
   * @return this assertion object.
   * @throws AssertionError if the actual Player's previousTeams does not contain all given com.cprohinig.assertj.generator.data.nba.team.Team elements.
   */
  public PlayerAssert hasPreviousTeams(java.util.Collection<? extends com.cprohinig.assertj.generator.data.nba.team.Team> previousTeams) {
    // check that actual Player we want to make assertions on is not null.
    isNotNull();

    // check that given com.cprohinig.assertj.generator.data.nba.team.Team collection is not null.
  ...
  /**
   * Verifies that the actual Player's previousTeams contains <b>only</b> the given com.cprohinig.assertj.generator.data.nba.team.Team elements and nothing else in whatever order.
   * @param previousTeams the given elements that should be contained in actual Player's previousTeams.
   * @return this assertion object.
   * @throws AssertionError if the actual Player's previousTeams does not contain all given com.cprohinig.assertj.generator.data.nba.team.Team elements.
   */
  public PlayerAssert hasOnlyPreviousTeams(com.cprohinig.assertj.generator.data.nba.team.Team... previousTeams) {
    // check that actual Player we want to make assertions on is not null.
    isNotNull();
  ...
  /**
   * Verifies that the actual Player's previousTeams contains <b>only</b> the given com.cprohinig.assertj.generator.data.nba.team.Team elements in Collection and nothing else in whatever order.
   * @param previousTeams the given elements that should be contained in actual Player's previousTeams.
   * @return this assertion object.
   * @throws AssertionError if the actual Player's previousTeams does not contain all given com.cprohinig.assertj.generator.data.nba.team.Team elements.
   */
  public PlayerAssert hasOnlyPreviousTeams(java.util.Collection<? extends com.cprohinig.assertj.generator.data.nba.team.Team> previousTeams) {
    // check that actual Player we want to make assertions on is not null.
    isNotNull();
  ...
  /**
   * Verifies that the actual Player's previousTeams does not contain the given com.cprohinig.assertj.generator.data.nba.team.Team elements.
   *
   * @param previousTeams the given elements that should not be in actual Player's previousTeams.
   * @return this assertion object.
   * @throws AssertionError if the actual Player's previousTeams contains any given com.cprohinig.assertj.generator.data.nba.team.Team elements.
   */
  public PlayerAssert doesNotHavePreviousTeams(com.cprohinig.assertj.generator.data.nba.team.Team... previousTeams) {
    // check that actual Player we want to make assertions on is not null.
    isNotNull();
  ...
  /**
   * Verifies that the actual Player's previousTeams does not contain the given com.cprohinig.assertj.generator.data.nba.team.Team elements in Collection.
   *
   * @param previousTeams the given elements that should not be in actual Player's previousTeams.
   * @return this assertion object.
   * @throws AssertionError if the actual Player's previousTeams contains any given com.cprohinig.assertj.generator.data.nba.team.Team elements.
   */
  public PlayerAssert doesNotHavePreviousTeams(java.util.Collection<? extends com.cprohinig.assertj.generator.data.nba.team.Team> previousTeams) {
    // check that actual Player we want to make assertions on is not null.
    isNotNull();
