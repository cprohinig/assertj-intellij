...
public class TeamAssert extends AbstractObjectAssert<TeamAssert, Team> {
  ...
  /**
   * Verifies that the actual Team's players contains the given com.cprohinig.assertj.generator.data.nba.Player elements.
   * @param players the given elements that should be contained in actual Team's players.
   * @return this assertion object.
   * @throws AssertionError if the actual Team's players does not contain all given com.cprohinig.assertj.generator.data.nba.Player elements.
   */
  public TeamAssert hasPlayers(com.cprohinig.assertj.generator.data.nba.Player... players) {
    // check that actual Team we want to make assertions on is not null.
    isNotNull();

    // check that given com.cprohinig.assertj.generator.data.nba.Player varargs is not null.
  ...
  /**
   * Verifies that the actual Team's players contains the given com.cprohinig.assertj.generator.data.nba.Player elements in Collection.
   * @param players the given elements that should be contained in actual Team's players.
   * @return this assertion object.
   * @throws AssertionError if the actual Team's players does not contain all given com.cprohinig.assertj.generator.data.nba.Player elements.
   */
  public TeamAssert hasPlayers(java.util.Collection<? extends com.cprohinig.assertj.generator.data.nba.Player> players) {
    // check that actual Team we want to make assertions on is not null.
    isNotNull();

    // check that given com.cprohinig.assertj.generator.data.nba.Player collection is not null.
    if (players == null) {
  ...
  /**
   * Verifies that the actual Team's players contains <b>only</b> the given com.cprohinig.assertj.generator.data.nba.Player elements and nothing else in whatever order.
   * @param players the given elements that should be contained in actual Team's players.
   * @return this assertion object.
   * @throws AssertionError if the actual Team's players does not contain all given com.cprohinig.assertj.generator.data.nba.Player elements.
   */
  public TeamAssert hasOnlyPlayers(com.cprohinig.assertj.generator.data.nba.Player... players) {
    // check that actual Team we want to make assertions on is not null.
    isNotNull();
  ...
  /**
   * Verifies that the actual Team's players contains <b>only</b> the given com.cprohinig.assertj.generator.data.nba.Player elements in Collection and nothing else in whatever order.
   * @param players the given elements that should be contained in actual Team's players.
   * @return this assertion object.
   * @throws AssertionError if the actual Team's players does not contain all given com.cprohinig.assertj.generator.data.nba.Player elements.
   */
  public TeamAssert hasOnlyPlayers(java.util.Collection<? extends com.cprohinig.assertj.generator.data.nba.Player> players) {
    // check that actual Team we want to make assertions on is not null.
    isNotNull();
  ...
  /**
   * Verifies that the actual Team's players does not contain the given com.cprohinig.assertj.generator.data.nba.Player elements.
   *
   * @param players the given elements that should not be in actual Team's players.
   * @return this assertion object.
   * @throws AssertionError if the actual Team's players contains any given com.cprohinig.assertj.generator.data.nba.Player elements.
   */
  public TeamAssert doesNotHavePlayers(com.cprohinig.assertj.generator.data.nba.Player... players) {
    // check that actual Team we want to make assertions on is not null.
    isNotNull();
  ...
  /**
   * Verifies that the actual Team's players does not contain the given com.cprohinig.assertj.generator.data.nba.Player elements in Collection.
   *
   * @param players the given elements that should not be in actual Team's players.
   * @return this assertion object.
   * @throws AssertionError if the actual Team's players contains any given com.cprohinig.assertj.generator.data.nba.Player elements.
   */
  public TeamAssert doesNotHavePlayers(java.util.Collection<? extends com.cprohinig.assertj.generator.data.nba.Player> players) {
    // check that actual Team we want to make assertions on is not null.
    isNotNull();
   ...
   */
  public TeamAssert hasVictoryRatioCloseTo(double victoryRatio, double assertjOffset) {
    // check that actual Team we want to make assertions on is not null.
    isNotNull();
    ...
    String assertjErrorMessage = String.format("\nExpecting victoryRatio:\n  <%s>\nto be close to:\n  <%s>\nby less than <%s> but difference was <%s>",
                                               actualVictoryRatio, victoryRatio, assertjOffset, Math.abs(victoryRatio - actualVictoryRatio));

    // check
    Assertions.assertThat(actualVictoryRatio).overridingErrorMessage(assertjErrorMessage).isCloseTo(victoryRatio, Assertions.within(assertjOffset));
