...
public class ClassUsingDifferentClassesWithSameNameAssert extends AbstractObjectAssert<ClassUsingDifferentClassesWithSameNameAssert, ClassUsingDifferentClassesWithSameName> {
   ...
   */
  public ClassUsingDifferentClassesWithSameNameAssert hasNbaTeam(com.cprohinig.assertj.generator.data.nba.team.Team nbaTeam) {
    ...
    // null safe check
    com.cprohinig.assertj.generator.data.nba.team.Team actualNbaTeam = actual.getNbaTeam();
   ...
   */
  public ClassUsingDifferentClassesWithSameNameAssert hasTeam(com.cprohinig.assertj.generator.data.Team team) {
    // check that actual ClassUsingDifferentClassesWithSameName we want to make assertions on is not null.
    isNotNull();
    ...
    // null safe check
    com.cprohinig.assertj.generator.data.Team actualTeam = actual.getTeam();
