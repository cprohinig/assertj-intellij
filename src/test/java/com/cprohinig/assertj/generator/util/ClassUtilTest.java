 ...
 */
package com.cprohinig.assertj.generator.util;

import com.cprohinig.assertj.generator.AssertionGeneratorTest;
...
import com.cprohinig.assertj.generator.data.inner.Data;
...
import com.cprohinig.assertj.generator.description.GetterDescriptionTest;
import com.cprohinig.assertj.generator.description.Visibility;
...
public class ClassUtilTest implements NestedClassesTest {
  ...
  public void should_throw_exception_when_classLoader_null() {
    collectClasses((ClassLoader) null, "com.cprohinig.assertj.generator.data");
  }
  ...
  public void should_get_classes_in_package_and_subpackages() {
    Set<TypeToken<?>> classesInPackage = collectClasses("com.cprohinig.assertj.generator.data");
  ...
  public void should_get_private_classes_when_included() {
    ...
    Set<TypeToken<?>> classesInPackage = collectClasses(classLoader,
                                                        true, "com.cprohinig.assertj.generator.data",
                                                        "com.cprohinig.assertj.generator.util.PackagePrivate");
  ...
  public void should_get_nested_classes() {
    ClassLoader classLoader = Thread.currentThread().getContextClassLoader();
    Set<TypeToken<?>> classesInPackage = collectClasses(classLoader, false, "com.cprohinig.assertj.generator.data.inner.Data");
  ...
  public void should_get_classes_with_provided_class_loader() {
    ClassLoader classLoader = Thread.currentThread().getContextClassLoader();
    Set<TypeToken<?>> classesInPackage = collectClasses(classLoader, "com.cprohinig.assertj.generator.data");
