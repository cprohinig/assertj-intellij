...
import com.cprohinig.assertj.generator.data.EnemyReport;
import com.cprohinig.assertj.generator.data.Name;
import com.cprohinig.assertj.generator.data.nba.Player;
import com.cprohinig.assertj.generator.data.nba.team.Coach;
...
import static com.cprohinig.assertj.generator.util.ClassUtil.propertyNameOf;
...
public class FieldDescriptionTest {
  ...
  public void should_create_valid_typename_from_class() throws Exception {
    ...
    assertThat(fieldDescription.getFullyQualifiedTypeName()).isEqualTo("com.cprohinig.assertj.generator.data.Name");
  }
  ...
  public void should_create_valid_typename_from_class_for_user_defined_type_in_same_package() throws Exception {
    ...
    assertThat(fieldDescription.getFullyQualifiedTypeName()).isEqualTo("com.cprohinig.assertj.generator.data.nba.team.Team");
  }
