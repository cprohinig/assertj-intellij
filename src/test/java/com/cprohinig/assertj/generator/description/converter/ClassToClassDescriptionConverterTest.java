...
import com.cprohinig.assertj.generator.BeanWithExceptionsTest;
import com.cprohinig.assertj.generator.NestedClassesTest;
import com.cprohinig.assertj.generator.data.*;
import com.cprohinig.assertj.generator.data.art.ArtWork;
import com.cprohinig.assertj.generator.data.lotr.FellowshipOfTheRing;
import com.cprohinig.assertj.generator.data.nba.Player;
import com.cprohinig.assertj.generator.data.nba.PlayerAgent;
...
import static com.cprohinig.assertj.generator.util.ClassUtil.getTypeDeclaration;
...
public class ClassToClassDescriptionConverterTest implements NestedClassesTest, BeanWithExceptionsTest {
  ...
  public void should_build_player_class_description() throws Exception {
    ...
    assertThat(classDescription.getPackageName()).isEqualTo("com.cprohinig.assertj.generator.data.nba");
    assertThat(classDescription.getFullyQualifiedClassName()).isEqualTo("com.cprohinig.assertj.generator.data.nba.Player");
    assertThat(classDescription.getFullyQualifiedOuterClassName()).isEqualTo("com.cprohinig.assertj.generator.data.nba.Player");
    ...
    assertThat(classDescription.getFullyQualifiedAssertClassName()).isEqualTo("com.cprohinig.assertj.generator.data.nba.PlayerAssert");
  ...
  public void should_build_movie_class_description() throws Exception {
    ...
    assertThat(classDescription.getPackageName()).isEqualTo("com.cprohinig.assertj.generator.data");
    ...
    assertThat(classDescription.getFullyQualifiedAssertClassName()).isEqualTo("com.cprohinig.assertj.generator.data.MovieAssert");
    ...
    assertThat(classDescription.getFullyQualifiedParentAssertClassName())
        .isEqualTo("com.cprohinig.assertj.generator.data.art.AbstractArtWorkAssert");
  ...
  public void should_build_fellowshipOfTheRing_class_description() throws Exception {
    ...
    assertThat(classDescription.getFullyQualifiedClassName()).isEqualTo("com.cprohinig.assertj.generator.data.lotr.FellowshipOfTheRing");
    assertThat(classDescription.getFullyQualifiedClassNameWithoutGenerics()).isEqualTo(classDescription.getFullyQualifiedClassName());
    assertThat(classDescription.getPackageName()).isEqualTo("com.cprohinig.assertj.generator.data.lotr");
    assertThat(classDescription.getGettersDescriptions()).hasSize(1);
  }
  ...
  public void should_build_class_description_for_class_with_public_fields() throws Exception {
    ...
    assertThat(classDescription.getFullyQualifiedClassName()).isEqualTo("com.cprohinig.assertj.generator.data.Team");
    assertThat(classDescription.getFullyQualifiedClassNameWithoutGenerics()).isEqualTo(classDescription.getFullyQualifiedClassName());
    assertThat(classDescription.getPackageName()).isEqualTo("com.cprohinig.assertj.generator.data");
