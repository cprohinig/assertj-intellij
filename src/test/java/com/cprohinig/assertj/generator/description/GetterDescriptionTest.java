...
public class GetterDescriptionTest {
  ...
  public void should_create_valid_typename_from_class_for_user_defined_type_in_same_package() throws Exception {
    ...
    assertThat(getterDescription.getFullyQualifiedTypeName()).isEqualTo("com.cprohinig.assertj.generator.data.lotr.Race");
  }
  ...
  public void should_create_valid_typename_from_class_for_user_defined_type_in_different_package() throws Exception {
    ...
    assertThat(getterDescription.getTypeName()).isEqualTo("com.cprohinig.assertj.generator.data.Name");
    assertThat(getterDescription.getFullyQualifiedTypeName()).isEqualTo("com.cprohinig.assertj.generator.data.Name");
  }
