...
public class BaseAssertionGenerator implements AssertionGenerator, AssertionsEntryPointGenerator {
  ...
  public String[] generateHierarchicalCustomAssertionContentFor(ClassDescription classDescription,
    ...
    String abstractAssertClassContent = templateRegistry.getTemplate(Template.Type.ABSTRACT_ASSERT_CLASS).getContent();
    ...
    String concreteAssertClassContent = templateRegistry.getTemplate(Template.Type.HIERARCHICAL_ASSERT_CLASS).getContent();
  ...
  public String generateCustomAssertionContentFor(ClassDescription classDescription) {
    ...
    String classTemplateContent = templateRegistry.getTemplate(Template.Type.ASSERT_CLASS).getContent();
  ...
  private Template chooseAssertionEntryPointMethodTemplate(final AssertionsEntryPointType assertionsEntryPointType) {
    ...
    case AUTO_CLOSEABLE_SOFT:
      return templateRegistry.getTemplate(Template.Type.SOFT_ENTRY_POINT_METHOD_ASSERTION);
    case BDD:
      return templateRegistry.getTemplate(Template.Type.BDD_ENTRY_POINT_METHOD_ASSERTION);
    case BDD_SOFT:
    case JUNIT_BDD_SOFT:
    case AUTO_CLOSEABLE_BDD_SOFT:
      return templateRegistry.getTemplate(Template.Type.BDD_SOFT_ENTRY_POINT_METHOD_ASSERTION);
    default:
      return templateRegistry.getTemplate(Template.Type.ASSERTION_ENTRY_POINT);
    }
  }
  ...
  private Template chooseAssertionEntryPointClassTemplate(final AssertionsEntryPointType assertionsEntryPointType) {
    switch (assertionsEntryPointType) {
    case SOFT:
      return templateRegistry.getTemplate(Template.Type.SOFT_ASSERTIONS_ENTRY_POINT_CLASS);
    case JUNIT_SOFT:
      return templateRegistry.getTemplate(Template.Type.JUNIT_SOFT_ASSERTIONS_ENTRY_POINT_CLASS);
    case AUTO_CLOSEABLE_SOFT:
      return templateRegistry.getTemplate(Template.Type.AUTO_CLOSEABLE_SOFT_ASSERTIONS_ENTRY_POINT_CLASS);
    case BDD:
      return templateRegistry.getTemplate(Template.Type.BDD_ASSERTIONS_ENTRY_POINT_CLASS);
    case BDD_SOFT:
      return templateRegistry.getTemplate(Template.Type.BDD_SOFT_ASSERTIONS_ENTRY_POINT_CLASS);
    case JUNIT_BDD_SOFT:
      return templateRegistry.getTemplate(Template.Type.JUNIT_BDD_SOFT_ASSERTIONS_ENTRY_POINT_CLASS);
    case AUTO_CLOSEABLE_BDD_SOFT:
      return templateRegistry.getTemplate(Template.Type.AUTO_CLOSEABLE_BDD_SOFT_ASSERTIONS_ENTRY_POINT_CLASS);
    default:
      return templateRegistry.getTemplate(Template.Type.ASSERTIONS_ENTRY_POINT_CLASS);
    }
  }
  ...
  private String baseAssertionContentFor(DataDescription fieldOrProperty, ClassDescription classDescription) {
    ...
    if (fieldOrProperty.isPredicate()) {
      ...
      assertionContent = replace(templateRegistry.getTemplate(Template.Type.HAS_FOR_ITERABLE).getContent(), ELEMENT_TYPE,
      ...
      assertionContent = replace(templateRegistry.getTemplate(Template.Type.HAS_FOR_ARRAY).getContent(), ELEMENT_TYPE,
                                 fieldOrProperty.getElementTypeName());
      assertionContent = replace(assertionContent, ELEMENT_ASSERT_TYPE,
                                 fieldOrProperty.getElementAssertTypeName());
    } else if (fieldOrProperty.isRealNumberType()) {
      Template.Type type = fieldOrProperty.isPrimitiveWrapperType() ? Template.Type.HAS_FOR_REAL_NUMBER_WRAPPER
          : Template.Type.HAS_FOR_REAL_NUMBER;
      assertionContent = templateRegistry.getTemplate(type).getContent();
    } else if (fieldOrProperty.isWholeNumberType()) {
      Template.Type type = fieldOrProperty.isPrimitiveWrapperType() ? Template.Type.HAS_FOR_WHOLE_NUMBER_WRAPPER
          : Template.Type.HAS_FOR_WHOLE_NUMBER;
      assertionContent = templateRegistry.getTemplate(type).getContent();
